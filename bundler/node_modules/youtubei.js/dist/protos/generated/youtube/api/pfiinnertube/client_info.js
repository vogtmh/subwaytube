...
export var ClientInfo_ClientFormFactor;
(function (ClientInfo_ClientFormFactor) {
    /** UNKNOWN_FORM_FACTOR - @TODO: Check these. */
    ClientInfo_ClientFormFactor[ClientInfo_ClientFormFactor["UNKNOWN_FORM_FACTOR"] = 0] = "UNKNOWN_FORM_FACTOR";
    ClientInfo_ClientFormFactor[ClientInfo_ClientFormFactor["FORM_FACTOR_VAL1"] = 1] = "FORM_FACTOR_VAL1";
    ClientInfo_ClientFormFactor[ClientInfo_ClientFormFactor["FORM_FACTOR_VAL2"] = 2] = "FORM_FACTOR_VAL2";
    ClientInfo_ClientFormFactor[ClientInfo_ClientFormFactor["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_ClientFormFactor || (ClientInfo_ClientFormFactor = {}));
export var ClientInfo_CameraType;
(function (ClientInfo_CameraType) {
    ClientInfo_CameraType[ClientInfo_CameraType["UNKNOWN_CAMERA_TYPE"] = 0] = "UNKNOWN_CAMERA_TYPE";
    ClientInfo_CameraType[ClientInfo_CameraType["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_CameraType || (ClientInfo_CameraType = {}));
export var ClientInfo_UserInterfaceTheme;
(function (ClientInfo_UserInterfaceTheme) {
    ClientInfo_UserInterfaceTheme[ClientInfo_UserInterfaceTheme["USER_INTERFACE_THEME_DARK"] = 0] = "USER_INTERFACE_THEME_DARK";
    ClientInfo_UserInterfaceTheme[ClientInfo_UserInterfaceTheme["USER_INTERFACE_THEME_LIGHT"] = 1] = "USER_INTERFACE_THEME_LIGHT";
    ClientInfo_UserInterfaceTheme[ClientInfo_UserInterfaceTheme["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_UserInterfaceTheme || (ClientInfo_UserInterfaceTheme = {}));
export var ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus;
(function (ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus) {
    ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus[ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus["STORE_DIGITAL_GOODS_API_SUPPORT_STATUS_VAL0"] = 0] = "STORE_DIGITAL_GOODS_API_SUPPORT_STATUS_VAL0";
    ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus[ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus || (ClientInfo_MainAppWebInfo_StoreDigitalGoodsApiSupportStatus = {}));
export var ClientInfo_MainAppWebInfo_PwaInstallabilityStatus;
(function (ClientInfo_MainAppWebInfo_PwaInstallabilityStatus) {
    ClientInfo_MainAppWebInfo_PwaInstallabilityStatus[ClientInfo_MainAppWebInfo_PwaInstallabilityStatus["PWA_INSTALLABILITY_STATUS_UNKNOWN"] = 0] = "PWA_INSTALLABILITY_STATUS_UNKNOWN";
    ClientInfo_MainAppWebInfo_PwaInstallabilityStatus[ClientInfo_MainAppWebInfo_PwaInstallabilityStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MainAppWebInfo_PwaInstallabilityStatus || (ClientInfo_MainAppWebInfo_PwaInstallabilityStatus = {}));
export var ClientInfo_MainAppWebInfo_WebDisplayMode;
(function (ClientInfo_MainAppWebInfo_WebDisplayMode) {
    ClientInfo_MainAppWebInfo_WebDisplayMode[ClientInfo_MainAppWebInfo_WebDisplayMode["WEB_DISPLAY_MODE_UNKNOWN"] = 0] = "WEB_DISPLAY_MODE_UNKNOWN";
    ClientInfo_MainAppWebInfo_WebDisplayMode[ClientInfo_MainAppWebInfo_WebDisplayMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MainAppWebInfo_WebDisplayMode || (ClientInfo_MainAppWebInfo_WebDisplayMode = {}));
export var ClientInfo_NotificationPermissionInfo_NotificationsSetting;
(function (ClientInfo_NotificationPermissionInfo_NotificationsSetting) {
    ClientInfo_NotificationPermissionInfo_NotificationsSetting[ClientInfo_NotificationPermissionInfo_NotificationsSetting["NOTIFICATIONS_SETTING_UNKNOWN"] = 0] = "NOTIFICATIONS_SETTING_UNKNOWN";
    ClientInfo_NotificationPermissionInfo_NotificationsSetting[ClientInfo_NotificationPermissionInfo_NotificationsSetting["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_NotificationPermissionInfo_NotificationsSetting || (ClientInfo_NotificationPermissionInfo_NotificationsSetting = {}));
export var ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel;
(function (ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel) {
    ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel[ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel["UNKNOWN"] = 0] = "UNKNOWN";
    ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel[ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel || (ClientInfo_SpacecastClientInfo_SpacecastInteractionLevel = {}));
export var ClientInfo_SpacecastClientInfo_SpacecastAppliance_OperationalStatus;
(function (ClientInfo_SpacecastClientInfo_SpacecastAppliance_OperationalStatus) {
    ClientInfo_SpacecastClientInfo_SpacecastAppliance_OperationalStatus[ClientInfo_SpacecastClientInfo_SpacecastAppliance_OperationalStatus["UNKNOWN"] = 0] = "UNKNOWN";
    ClientInfo_SpacecastClientInfo_SpacecastAppliance_OperationalStatus[ClientInfo_SpacecastClientInfo_SpacecastAppliance_OperationalStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
export var ClientInfo_KidsAppInfo_KidsParentCurationMode;
(function (ClientInfo_KidsAppInfo_KidsParentCurationMode) {
    ClientInfo_KidsAppInfo_KidsParentCurationMode[ClientInfo_KidsAppInfo_KidsParentCurationMode["KPCM_UNKNOWN"] = 0] = "KPCM_UNKNOWN";
    ClientInfo_KidsAppInfo_KidsParentCurationMode[ClientInfo_KidsAppInfo_KidsParentCurationMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_KidsAppInfo_KidsParentCurationMode || (ClientInfo_KidsAppInfo_KidsParentCurationMode = {}));
export var ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode;
(function (ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode) {
    ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode[ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode["YT_KIDS_NO_SEARCH_MODE_OFF"] = 0] = "YT_KIDS_NO_SEARCH_MODE_OFF";
    ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode[ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode["YT_KIDS_NO_SEARCH_MODE_ON"] = 1] = "YT_KIDS_NO_SEARCH_MODE_ON";
    ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode[ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsNoSearchMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
export var ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode;
(function (ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode) {
    ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode[ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode["YT_KIDS_AGE_UP_MODE_OFF"] = 0] = "YT_KIDS_AGE_UP_MODE_OFF";
    ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode[ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode["YT_KIDS_AGE_UP_MODE_ON"] = 1] = "YT_KIDS_AGE_UP_MODE_ON";
    ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode[ClientInfo_KidsAppInfo_KidsContentSettings_YTKidsAgeUpMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
(function (ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity) {
    ...
    ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity[ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity["YT_KIDS_CONTENT_DENSITY_VAL1"] = 0] = "YT_KIDS_CONTENT_DENSITY_VAL1";
    ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity[ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity["YT_KIDS_CONTENT_DENSITY_VAL2"] = 1] = "YT_KIDS_CONTENT_DENSITY_VAL2";
    ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity[ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity["YT_KIDS_CONTENT_DENSITY_VAL3"] = 2] = "YT_KIDS_CONTENT_DENSITY_VAL3";
    ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity[ClientInfo_KidsAppInfo_KidsContentSettings_KidsContentDensity["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
export var ClientInfo_MusicAppInfo_MusicPlayBackMode;
(function (ClientInfo_MusicAppInfo_MusicPlayBackMode) {
    ClientInfo_MusicAppInfo_MusicPlayBackMode[ClientInfo_MusicAppInfo_MusicPlayBackMode["MPBM_UNKNOWN"] = 0] = "MPBM_UNKNOWN";
    ClientInfo_MusicAppInfo_MusicPlayBackMode[ClientInfo_MusicAppInfo_MusicPlayBackMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
...
(function (ClientInfo_MusicAppInfo_MusicLocationMasterSwitch) {
    ClientInfo_MusicAppInfo_MusicLocationMasterSwitch[ClientInfo_MusicAppInfo_MusicLocationMasterSwitch["MLMS_UNKNOWN"] = 0] = "MLMS_UNKNOWN";
    ClientInfo_MusicAppInfo_MusicLocationMasterSwitch[ClientInfo_MusicAppInfo_MusicLocationMasterSwitch["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MusicAppInfo_MusicLocationMasterSwitch || (ClientInfo_MusicAppInfo_MusicLocationMasterSwitch = {}));
export var ClientInfo_MusicAppInfo_MusicActivityMasterSwitch;
(function (ClientInfo_MusicAppInfo_MusicActivityMasterSwitch) {
    ClientInfo_MusicAppInfo_MusicActivityMasterSwitch[ClientInfo_MusicAppInfo_MusicActivityMasterSwitch["MAMS_UNKNOWN"] = 0] = "MAMS_UNKNOWN";
    ClientInfo_MusicAppInfo_MusicActivityMasterSwitch[ClientInfo_MusicAppInfo_MusicActivityMasterSwitch["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MusicAppInfo_MusicActivityMasterSwitch || (ClientInfo_MusicAppInfo_MusicActivityMasterSwitch = {}));
export var ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus;
(function (ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus) {
    ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus[ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus["UNKNOWN_STATUS"] = 0] = "UNKNOWN_STATUS";
    ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus[ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus || (ClientInfo_MusicAppInfo_IosBackgroundRefreshStatus = {}));
export var ClientInfo_MusicAppInfo_PwaInstallabilityStatus;
(function (ClientInfo_MusicAppInfo_PwaInstallabilityStatus) {
    ClientInfo_MusicAppInfo_PwaInstallabilityStatus[ClientInfo_MusicAppInfo_PwaInstallabilityStatus["PIS_UNKNOWN"] = 0] = "PIS_UNKNOWN";
    ClientInfo_MusicAppInfo_PwaInstallabilityStatus[ClientInfo_MusicAppInfo_PwaInstallabilityStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MusicAppInfo_PwaInstallabilityStatus || (ClientInfo_MusicAppInfo_PwaInstallabilityStatus = {}));
export var ClientInfo_MusicAppInfo_WebDisplayMode;
(function (ClientInfo_MusicAppInfo_WebDisplayMode) {
    ClientInfo_MusicAppInfo_WebDisplayMode[ClientInfo_MusicAppInfo_WebDisplayMode["WDM_UNKNOWN"] = 0] = "WDM_UNKNOWN";
    ClientInfo_MusicAppInfo_WebDisplayMode[ClientInfo_MusicAppInfo_WebDisplayMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MusicAppInfo_WebDisplayMode || (ClientInfo_MusicAppInfo_WebDisplayMode = {}));
export var ClientInfo_MusicAppInfo_MusicTier;
(function (ClientInfo_MusicAppInfo_MusicTier) {
    ClientInfo_MusicAppInfo_MusicTier[ClientInfo_MusicAppInfo_MusicTier["UNKNOWN_TIER"] = 0] = "UNKNOWN_TIER";
    ClientInfo_MusicAppInfo_MusicTier[ClientInfo_MusicAppInfo_MusicTier["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(ClientInfo_MusicAppInfo_MusicTier || (ClientInfo_MusicAppInfo_MusicTier = {}));
export var ClientInfo_MusicAppInfo_StoreDigitalGoodsApiSupportStatus;
(function (ClientInfo_MusicAppInfo_StoreDigitalGoodsApiSupportStatus) {
    ClientInfo_MusicAppInfo_StoreDigitalGoodsApiSupportStatus[ClientInfo_MusicAppInfo_StoreDigitalGoodsApiSupportStatus["SDGAS_UNKNOWN"] = 0] = "SDGAS_UNKNOWN";
    ClientInfo_MusicAppInfo_StoreDigitalGoodsApiSupportStatus[ClientInfo_MusicAppInfo_StoreDigitalGoodsApiSupportStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
