var _ReelWatchEndpoint_API_PATH, _ReelWatchEndpoint_data;
import { __classPrivateFieldGet, __classPrivateFieldSet } from "tslib";
import { YTNode } from '../../helpers.js';
class ReelWatchEndpoint extends YTNode {
    constructor(data) {
        super();
        _ReelWatchEndpoint_API_PATH.set(this, 'reel/reel_item_watch');
        _ReelWatchEndpoint_data.set(this, void 0);
        __classPrivateFieldSet(this, _ReelWatchEndpoint_data, data, "f");
    }
    getApiPath() {
        return __classPrivateFieldGet(this, _ReelWatchEndpoint_API_PATH, "f");
    }
    buildRequest() {
        const request = {};
...
_ReelWatchEndpoint_API_PATH = new WeakMap(), _ReelWatchEndpoint_data = new WeakMap();
