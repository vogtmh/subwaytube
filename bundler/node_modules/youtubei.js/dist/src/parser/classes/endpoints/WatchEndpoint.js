var _WatchEndpoint_API_PATH, _WatchEndpoint_data;
import { __classPrivateFieldGet, __classPrivateFieldSet } from "tslib";
import { YTNode } from '../../helpers.js';
class WatchEndpoint extends YTNode {
    constructor(data) {
        super();
        _WatchEndpoint_API_PATH.set(this, 'player');
        _WatchEndpoint_data.set(this, void 0);
        __classPrivateFieldSet(this, _WatchEndpoint_data, data, "f");
    }
    getApiPath() {
        return __classPrivateFieldGet(this, _WatchEndpoint_API_PATH, "f");
    }
    buildRequest() {
        const request = {};
...
_WatchEndpoint_API_PATH = new WeakMap(), _WatchEndpoint_data = new WeakMap();
