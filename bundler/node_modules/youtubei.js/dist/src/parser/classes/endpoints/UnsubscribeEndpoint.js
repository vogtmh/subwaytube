var _UnsubscribeEndpoint_API_PATH, _UnsubscribeEndpoint_data;
import { __classPrivateFieldGet, __classPrivateFieldSet } from "tslib";
import { YTNode } from '../../helpers.js';
class UnsubscribeEndpoint extends YTNode {
    constructor(data) {
        super();
        _UnsubscribeEndpoint_API_PATH.set(this, 'subscription/unsubscribe');
        _UnsubscribeEndpoint_data.set(this, void 0);
        __classPrivateFieldSet(this, _UnsubscribeEndpoint_data, data, "f");
    }
    getApiPath() {
        return __classPrivateFieldGet(this, _UnsubscribeEndpoint_API_PATH, "f");
    }
    buildRequest() {
        const request = {};
...
_UnsubscribeEndpoint_API_PATH = new WeakMap(), _UnsubscribeEndpoint_data = new WeakMap();
