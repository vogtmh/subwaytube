var _CreateCommentEndpoint_API_PATH, _CreateCommentEndpoint_data;
import { __classPrivateFieldGet, __classPrivateFieldSet } from "tslib";
import { YTNode } from '../../helpers.js';
class CreateCommentEndpoint extends YTNode {
    constructor(data) {
        super();
        _CreateCommentEndpoint_API_PATH.set(this, 'comment/create_comment');
        _CreateCommentEndpoint_data.set(this, void 0);
        __classPrivateFieldSet(this, _CreateCommentEndpoint_data, data, "f");
    }
    getApiPath() {
        return __classPrivateFieldGet(this, _CreateCommentEndpoint_API_PATH, "f");
    }
    buildRequest() {
        const request = {};
...
_CreateCommentEndpoint_API_PATH = new WeakMap(), _CreateCommentEndpoint_data = new WeakMap();
