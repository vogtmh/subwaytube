var _BrowseEndpoint_API_PATH, _BrowseEndpoint_data;
import { __classPrivateFieldGet, __classPrivateFieldSet } from "tslib";
import { YTNode } from '../../helpers.js';
class BrowseEndpoint extends YTNode {
    constructor(data) {
        super();
        _BrowseEndpoint_API_PATH.set(this, 'browse');
        _BrowseEndpoint_data.set(this, void 0);
        __classPrivateFieldSet(this, _BrowseEndpoint_data, data, "f");
    }
    getApiPath() {
        return __classPrivateFieldGet(this, _BrowseEndpoint_API_PATH, "f");
    }
    buildRequest() {
        const request = {};
...
_BrowseEndpoint_API_PATH = new WeakMap(), _BrowseEndpoint_data = new WeakMap();
