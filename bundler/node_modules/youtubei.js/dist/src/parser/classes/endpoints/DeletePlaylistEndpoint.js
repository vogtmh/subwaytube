var _DeletePlaylistEndpoint_API_PATH, _DeletePlaylistEndpoint_data;
import { __classPrivateFieldGet, __classPrivateFieldSet } from "tslib";
import { YTNode } from '../../helpers.js';
class DeletePlaylistEndpoint extends YTNode {
    constructor(data) {
        super();
        _DeletePlaylistEndpoint_API_PATH.set(this, 'playlist/delete');
        _DeletePlaylistEndpoint_data.set(this, void 0);
        __classPrivateFieldSet(this, _DeletePlaylistEndpoint_data, data, "f");
    }
    getApiPath() {
        return __classPrivateFieldGet(this, _DeletePlaylistEndpoint_API_PATH, "f");
    }
    buildRequest() {
        const request = {};
...
_DeletePlaylistEndpoint_API_PATH = new WeakMap(), _DeletePlaylistEndpoint_data = new WeakMap();
