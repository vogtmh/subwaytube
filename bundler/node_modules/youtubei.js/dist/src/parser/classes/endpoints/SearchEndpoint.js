var _SearchEndpoint_API_PATH, _SearchEndpoint_data;
import { __classPrivateFieldGet, __classPrivateFieldSet } from "tslib";
import { YTNode } from '../../helpers.js';
class SearchEndpoint extends YTNode {
    constructor(data) {
        super();
        _SearchEndpoint_API_PATH.set(this, 'search');
        _SearchEndpoint_data.set(this, void 0);
        __classPrivateFieldSet(this, _SearchEndpoint_data, data, "f");
    }
    getApiPath() {
        return __classPrivateFieldGet(this, _SearchEndpoint_API_PATH, "f");
    }
    buildRequest() {
        const request = {};
...
_SearchEndpoint_API_PATH = new WeakMap(), _SearchEndpoint_data = new WeakMap();
