...
class Library {
    constructor(response, actions) {
        ...
        const section_list = __classPrivateFieldGet(this, _Library_page, "f").contents_memo?.getType(SectionList).first();
    ...
    async applySort(sort_by) {
        ...
        if (typeof sort_by === 'string') {
            const button = __classPrivateFieldGet(this, _Library_page, "f").contents_memo?.getType(MusicSortFilterButton).first();
    ...
    async applyFilter(filter) {
        let target_chip;
        const chip_cloud = __classPrivateFieldGet(this, _Library_page, "f").contents_memo?.getType(ChipCloud).first();
    ...
    get filters() {
        return __classPrivateFieldGet(this, _Library_page, "f").contents_memo?.getType(ChipCloud)?.first().chips.map((chip) => chip.text) || [];
    }
    get page() {
