...
class Search {
    ...
    get did_you_mean() {
        return __classPrivateFieldGet(this, _Search_page, "f").contents_memo?.getType(DidYouMean).first();
    }
    get showing_results_for() {
        return __classPrivateFieldGet(this, _Search_page, "f").contents_memo?.getType(ShowingResultsFor).first();
    }
    get message() {
        return __classPrivateFieldGet(this, _Search_page, "f").contents_memo?.getType(Message).first();
    }
    get songs() {
