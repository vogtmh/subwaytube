...
class Album {
    constructor(response) {
        ...
        this.header = __classPrivateFieldGet(this, _Album_page, "f").contents_memo.getType(MusicDetailHeader, MusicResponsiveHeader)?.first();
        this.contents = __classPrivateFieldGet(this, _Album_page, "f").contents_memo.getType(MusicShelf)?.first().contents || observe([]);
