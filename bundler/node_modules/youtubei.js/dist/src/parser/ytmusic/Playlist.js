    ...
    constructor(response, actions) {
        ...
        if (__classPrivateFieldGet(this, _Playlist_page, "f").continuation_contents) {
            ...
            if (!__classPrivateFieldGet(this, _Playlist_page, "f").contents_memo)
                throw new InnertubeError('No contents found in the response');
            this.header = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo.getType(MusicResponsiveHeader, MusicEditablePlaylistDetailHeader, MusicDetailHeader)?.first();
            this.contents = __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo.getType(MusicPlaylistShelf)?.first()?.contents || observe([]);
            this.background = __classPrivateFieldGet(this, _Playlist_page, "f").background;
            __classPrivateFieldSet(this, _Playlist_continuation, __classPrivateFieldGet(this, _Playlist_page, "f").contents_memo.getType(MusicPlaylistShelf)?.first()?.continuation || null, "f");
        }
    }
    /**
