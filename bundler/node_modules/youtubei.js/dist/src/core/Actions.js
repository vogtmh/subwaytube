...
class Actions {
    ...
    async execute(endpoint, args) {
        ...
        if (args?.parse) {
            ...
            // Handle redirects
            if (__classPrivateFieldGet(this, _Actions_instances, "m", _Actions_isBrowse).call(this, parsed_response) && parsed_response.on_response_received_actions?.first()?.type === 'navigateAction') {
...
_Actions_instances = new WeakSet(), _Actions_wrap = 
/**
 * Mimics the Axios API using Fetch's Response object.
 * @param response - The response object.
 */
async function _Actions_wrap(response) {
    return {
        success: response.ok,
