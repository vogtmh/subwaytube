...
class Music {
    ...
    async getSearchSuggestions(input) {
        const response = await __classPrivateFieldGet(this, _Music_actions, "f").execute('/music/get_search_suggestions', { input, client: 'YTMUSIC', parse: true });
...
_Music_session = new WeakMap(), _Music_actions = new WeakMap(), _Music_instances = new WeakSet(), _Music_fetchInfoFromVideoId = async function _Music_fetchInfoFromVideoId(video_id) {
    ...
    const watch_response = watch_endpoint.call(__classPrivateFieldGet(this, _Music_actions, "f"), {
        playbackContext: {
