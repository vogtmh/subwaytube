...
class Kids {
    ...
    async getInfo(video_id) {
        ...
        const watch_response = watch_endpoint.call(__classPrivateFieldGet(this, _Kids_session, "f").actions, {
            playbackContext: {
                contentPlaybackContext: {
                    vis: 0,
                    splay: false,
                    lactMilliseconds: '-1',
                    signatureTimestamp: __classPrivateFieldGet(this, _Kids_session, "f").player?.sts
                }
            },
            client: 'YTKIDS'
        });
        const watch_next_response = watch_next_endpoint.call(__classPrivateFieldGet(this, _Kids_session, "f").actions, { client: 'YTKIDS' });
    ...
    async blockChannel(channel_id) {
        ...
        const response = await kids_blocklist_picker_command.call(__classPrivateFieldGet(this, _Kids_session, "f").actions, { client: 'YTKIDS' });
